...
export const pengelolaanLahanData: IzinPengelolaanLahan[] = [
  ...
  },
  {
    ...
    lokasi_lahan: 'Blok F - Lahan Desa RT 01/RW 04',
    tujuan_pengelolaan: 'Budidaya Cabe',
    luas_lahan: '0.8 Hektar',
    status: 'Diproses',
  ...
  {
    id: 'PL007',
    nama_pemohon: 'Tono Sutrisno',
    lokasi_lahan: 'Blok G - Lahan Desa RT 02/RW 04',
    tujuan_pengelolaan: 'Kebun Singkong',
    luas_lahan: '1.5 Hektar',
    status: 'Disetujui',
  ...
  {
    id: 'PL008',
    nama_pemohon: 'Usman Hakim',
    lokasi_lahan: 'Blok H - Lahan Desa RT 03/RW 04',
    tujuan_pengelolaan: 'Budidaya Tomat',
    luas_lahan: '0.6 Hektar',
    status: 'Diproses',
    tanggal_pengajuan: '2025-07-03',
  },
  {
    id: 'PL009',
    nama_pemohon: 'Vivi Lestari',
    lokasi_lahan: 'Blok I - Lahan Desa RT 01/RW 05',
    tujuan_pengelolaan: 'Kebun Kangkung',
    luas_lahan: '0.4 Hektar',
    status: 'Disetujui',
    tanggal_pengajuan: '2025-07-04',
  },
  {
    id: 'PL010',
    nama_pemohon: 'Wahyu Prasetyo',
    lokasi_lahan: 'Blok J - Lahan Desa RT 02/RW 05',
    tujuan_pengelolaan: 'Budidaya Terong',
    luas_lahan: '0.7 Hektar',
    status: 'Diproses',
    tanggal_pengajuan: '2025-07-05',
  },
  {
    id: 'PL011',
    nama_pemohon: 'Xenia Dewi',
    lokasi_lahan: 'Blok K - Lahan Desa RT 03/RW 05',
    tujuan_pengelolaan: 'Kebun Bayam',
  ...
  {
    id: 'PL012',
    nama_pemohon: 'Yusuf Rahman',
    lokasi_lahan: 'Blok L - Lahan Desa RT 01/RW 06',
    tujuan_pengelolaan: 'Budidaya Kacang',
    luas_lahan: '1.0 Hektar',
    status: 'Diproses',
