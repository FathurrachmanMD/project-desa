...
export const pengantarSKCKData: SuratPengantarSKCK[] = [
  ...
  {
    id: 'SKCK006',
    nama_pemohon: 'Fani Rahman',
    nik: '3210321654987006',
    tujuan_skck: 'Melamar kerja BUMN',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Diproses',
    tanggal_pengajuan: '2025-07-12',
  },
  {
    id: 'SKCK007',
    nama_pemohon: 'Gilang Pratama',
    nik: '3210321654987007',
    tujuan_skck: 'Visa luar negeri',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Disetujui',
  ...
  {
    id: 'SKCK008',
    nama_pemohon: 'Hana Firdaus',
    nik: '3210321654987008',
    tujuan_skck: 'Melamar kerja swasta',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Ditolak',
  ...
  {
    id: 'SKCK009',
    nama_pemohon: 'Indra Kusuma',
    nik: '3210321654987009',
    tujuan_skck: 'Keperluan administrasi',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Diproses',
  ...
  },
  {
    ...
    nik: '3210321654987010',
    tujuan_skck: 'Melamar kerja PNS',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Disetujui',
  ...
  {
    id: 'SKCK011',
    nama_pemohon: 'Kartika Sari',
    nik: '3210321654987011',
    tujuan_skck: 'Keperluan beasiswa',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Diproses',
  ...
  {
    id: 'SKCK012',
    nama_pemohon: 'Lucky Hakim',
    nik: '3210321654987012',
    tujuan_skck: 'Melamar kerja TNI',
    tempat_tujuan_skck: 'Polsek Cibiru',
    status: 'Disetujui',
...
export const keteranganDomisiliData: SuratKeteranganDomisili[] = [
  ...
  {
    id: 'DOM005',
    nama_warga: 'Citra Dewi',
    alamat_domisili: 'Jl. Mawar No. 20',
    lama_tinggal: 'Sejak 2018',
    rt_rw: 'RT 01 / RW 02',
    status: 'Ditolak',
    tanggal_pengajuan: '2025-07-09',
  },
  {
    ...
    alamat_domisili: 'Jl. Anggrek No. 25',
    lama_tinggal: 'Sejak 2020',
    rt_rw: 'RT 03 / RW 04',
    status: 'Diproses',
    tanggal_pengajuan: '2025-07-12',
  ...
  {
    id: 'DOM007',
    nama_warga: 'Evi Lestari',
    alamat_domisili: 'Jl. Dahlia No. 30',
    lama_tinggal: 'Sejak 2017',
    rt_rw: 'RT 02 / RW 03',
    status: 'Disetujui',
    tanggal_pengajuan: '2025-07-10',
  },
  {
    ...
    alamat_domisili: 'Jl. Cempaka No. 35',
    lama_tinggal: 'Sejak 2019',
    rt_rw: 'RT 01 / RW 02',
    status: 'Diproses',
    tanggal_pengajuan: '2025-07-13',
  ...
  {
    id: 'DOM009',
    nama_warga: 'Gina Aprilia',
    alamat_domisili: 'Jl. Tulip No. 40',
  ...
  {
    id: 'DOM010',
    nama_warga: 'Heri Setiawan',
    alamat_domisili: 'Jl. Sakura No. 45',
    lama_tinggal: 'Sejak 2018',
    rt_rw: 'RT 02 / RW 03',
    status: 'Diproses',
    tanggal_pengajuan: '2025-07-14',
  ...
  {
    id: 'DOM011',
    nama_warga: 'Ika Putri',
    alamat_domisili: 'Jl. Lily No. 50',
    lama_tinggal: 'Sejak 2020',
    rt_rw: 'RT 01 / RW 02',
    status: 'Disetujui',
    tanggal_pengajuan: '2025-07-07',
  ...
  {
    id: 'DOM012',
    nama_warga: 'Jaka Sembiring',
    alamat_domisili: 'Jl. Orchid No. 55',
    lama_tinggal: 'Sejak 2019',
    rt_rw: 'RT 03 / RW 04',
    status: 'Diproses',
