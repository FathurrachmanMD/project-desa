...
import { Building, FileCheck, ListFilter, TreePine, Wrench } from 'lucide-react';
...
const permitTypes = [
    { key: 'imb', label: 'Surat IMB', icon: Building },
    { key: 'lahandesa', label: 'Surat Lahan Desa', icon: TreePine },
    { key: 'tidaksengketa', label: 'Surat Sengketa', icon: FileCheck },
    { key: 'renovasi', label: 'Surat Renovasi', icon: Wrench },
];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto px-6 py-8">
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Manajemen Perizinan Bangunan</h1>
                        <p className="mt-1 text-muted-foreground">Kelola semua jenis perizinan bangunan dalam satu dashboard</p>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <Card className="shadow-sm">
                    <CardHeader className="pb-4">
                        ...
                        <CardDescription>Kelola semua jenis perizinan bangunan yang diajukan warga</CardDescription>
                    </CardHeader>
