...
export default function FormBangunan() {
    ...
    return (
        <>
            ...
            <Navbar />
            {/* Section: Perizinan Bangunan */}
            <section className="bg-white w-full pt-32 pb-8 md:pt-40 md:pb-12 border-b">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#1E4359] mb-2">Perizinan Bangunan</h2>
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto">Layanan perizinan bangunan digital yang mudah, cepat, dan transparan untuk warga Desa Drawati.</p>
                </div>
            </section>
                        ...
                        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
                            <div className="text-center">
                                ...
                                <h1 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                                    Form Perizinan Bangunan
                                </h1>
                                <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
                                    Pilih jenis perizinan bangunan yang sesuai dengan kebutuhan Anda. 
